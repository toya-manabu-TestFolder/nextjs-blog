    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          <Link href="https://nextjs.org/learn?utm_source=create-next-app&utm_medium=default-template&utm_campaign=create-next-app">
            <h2 className={inter.className}>
              Learn2 <span>-&gt;</span>
            </h2>
            <p className={inter.className}>
          ...
          <Link href="https://vercel.com/templates?framework=next.js&utm_source=create-next-app&utm_medium=default-template&utm_campaign=create-next-app">
            <h2 className={inter.className}>
              Templates <span>-&gt;</span>
            </h2>
            <p className={inter.className}>
